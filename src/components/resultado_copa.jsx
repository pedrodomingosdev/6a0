...
export default function ResultadoCopa({ partidasSimuladas, mediaOverall, formacaoEscolhida, jogadorasEmCampo, onRestart }) {
    ...
    // REFERÊNCIA DE VELOCIDADE (Permite mudar a velocidade em tempo real)
    ...
    const animacoesCss = `
        ...
        /* ================= DECORAÇÃO E SELETOR MOBILE PARA RESULTADOS ================= */
        @media (max-width: 768px) {
          ...
          .tournament-container, .summary-container {
            width: 100% !important;
          ...
          /* Histórico dos Cards das Partidas */
          .match-card {
            flex-direction: column !important;
          ...
          .match-stage {
            ...
            border-bottom: 1px dashed #EAE5D9 !important;
          ...
          .match-score-area {
            ...
            border-top: 1px dashed #EAE5D9 !important;
          ...
          /* Tela Final do Resumo de Campanha */
          .summary-title {
            ...
            <div className="anime-up delay-1 tournament-container" style={styles.tournamentContainer}>
                ...
                {simulandoAgora && (
                    <div className="anime-up live-match-panel" style={styles.liveMatchPanel}>
                        ...
                        {/* PLACAR VISUAL DOS PÊNALTIS (BOLINHAS) */}
                ...
                <div className="anime-up delay-3" style={{ textAlign: "center", marginTop: "40px", display: "flex", flexDirection: "column", alignItems: "center", gap: "15px" }}>
